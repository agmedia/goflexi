                                ...
                                <div class="tab-pane fade show @if ($lang->code == current_locale()) active @endif" id="pills-{{ $lang->code }}" role="tabpanel" aria-labelledby="pills-{{ $lang->code }}-tab">
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="title-{{ $lang->code }}" name="title[{{ $lang->code }}]" placeholder="{{ $lang->code }}" />
                                        </div>
                                        <div class="col-12 mt-5">
                                            <label for="description-{{ $lang->code }}">Description</label>
                                            <textarea id="description-{{ $lang->code }}" class="form-control" rows="4" data-always-show="true" name="description[{{ $lang->code }}]" placeholder="{{ $lang->code }}" data-placement="top"></textarea>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="from-city" name="from_city" />
                            </div>
                            <div class="col-6 mt-3">
                                <label for="from-longitude">From Longitude</label>
                                <input type="text" class="form-control" id="from-longitude" name="from_longitude" />
                            </div>
                            <div class="col-6 mt-3">
                                <label for="from-latitude">Latitude</label>
                                <input type="text" class="form-control" id="from-latitude" name="from_latitude" />
                            </div>
                        </div>
                        <div class="form-group row mt-5">
                            <div class="col-12">
                                <label for="to-city">To City</label>
                                <input type="text" class="form-control" id="to-city" name="to_city" />
                            </div>
                            <div class="col-6 mt-3">
                                <label for="to-longitude">To Longitude</label>
                                <input type="text" class="form-control" id="to-longitude" name="to_longitude" />
                            </div>
                            <div class="col-6 mt-3">
                                <label for="to-latitude">Latitude</label>
                                <input type="text" class="form-control" id="to-latitude" name="to_latitude" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group row">
                            <div class="col-6 mb-3">
                                ...
                                <div class="input-group date">
                                    <input type="text" class="form-control" placeholder="Datum polaska..." id="start-date" name="start_date">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <div class="input-group timepicker">
                                    <input class="form-control" id="start-time" placeholder="Select time" type="text" name="start_time">
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <div class="input-group date">
                                    <input type="text" class="form-control" placeholder="Datum dolaska..." id="end-date" name="end_date">
                                    <span class="input-group-text"><i class="feather icon-calendar"></i></span>
                                </div>
                            </div>
                            <div class="col-6 mt-3">
                                ...
                                <div class="input-group timepicker">
                                    <input class="form-control" id="end-time" placeholder="Select time" type="text" name="end_time">
                                    <span class="input-group-text"><i class="feather icon-clock"></i></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="price-child-input" name="price_child" />
                            </div>
                            <div class="col-12 mt-3">
                                <label for="quantity-input">Količina</label>
                                <input type="text" class="form-control" id="quantity-input" name="quantity" />
                            </div>
                        </div>
                    </div>
                </div>
