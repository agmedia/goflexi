                        ...
                        <div class="row justify-content-center mb-3">
                            <div class="col-md-11 mt-3">
                                <div class="form-group row items-push mb-0">
                                    ...
                                    <div class="col-md-5">
                                        <h2 class="content-heading">{{ __('back/app.order.date') }} @include('back.layouts.partials.required')</h2>
                                    ...
                                    <div class="col-md-7">
                                        <h2 class="content-heading">{{ __('back/app.order.select_payments') }} @include('back.layouts.partials.required')</h2>
                                        <div class="row mb-4">
                                            <div class="col-md-12">
...
<!--                                            <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <label for="adults-input">{{ __('back/app.order.adults') }} @include('back.layouts.partials.required')</label>
