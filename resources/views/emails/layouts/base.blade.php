    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
        ...
        <tr>
            <td style="padding: 20px 0 15px 0; text-align: center">
                <label class="large bold" style="color: white;">   <img src="{{ asset('media/image/logo-goflexi.png') }}" alt="goflexi" border="0" style="max-width:200px;height: auto;"></label>
            </td>
        </tr>
        <!-- Email Header : END -->
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
        <tr>
            <td style="padding: 20px;  font-size: 12px; line-height: 15px; text-align: center; color: #373f50;">
                GoFlexi © {{ now()->year }}. {{ __('front/apartment.sva_prava') }}. <br><a href="info/uvjeti-prodaje" style="color:#ffffff;">{{ __('front/apartment.uvjeti') }}</a>
                <br>
            </td>
        </tr>
    </table>
