...
use App\Http\Controllers\Back\Settings\System\Author;
use App\Http\Controllers\Controller;
use App\Models\Back\Marketing\Faq;
...
class FaqController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('back.marketing.faq.index', compact('faqs'));
    }
    ...
    {
        return view('back.marketing.faq.edit');
    }
    ...
    {
        return view('back.marketing.faq.edit', compact('faq'));
    }
