...
class WidgetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('back.catalog.widget.index', compact('widgets'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('back.catalog.widget.edit', compact('resources', 'resource_data'));
    }
    ...
    public function edit(Widget $widget)
    {
        ...
        return view('back.catalog.widget.edit', compact('widget', 'resources', 'resource_data', 'data'));
    }
