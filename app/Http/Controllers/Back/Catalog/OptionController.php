...
use App\Models\Back\Catalog\Option\Option;
...
class OptionController extends Controller
{
    ...
    {
        $options = Option::paginate(config('settings.pagination.back'));
    ...
    public function create()
    {
        ...
        return view('back.catalog.options.edit', compact('groups'));
    }
    ...
    public function edit(Option $option)
    {
        ...
        return view('back.catalog.options.edit', compact('option', 'groups'));
    }
